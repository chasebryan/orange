...
GATE0_ALLOWED_WRITE_PERMISSIONS = {"scorecard.yml": {"id-token", "security-events"}}
GATE0_SCHEMA_PATHS = {
    "schemas/gate0/claim-record-v0.1.schema.json",
    "schemas/gate0/evidence-manifest-v0.1.schema.json",
    "schemas/gate0/repository-control-snapshot-v0.1.schema.json",
...
GATE0_PROTECTED_FILE_DIGESTS = {
    ...
    ".github/workflows/scorecard.yml": "2bc9f8d5ade899bd305e384f7e8adb990ace1bb673135c1dfc382ef593d09fcc",
    ...
    "docs/operations/CI_DEPENDENCIES.md": "99d5bbf3b67bd5cb86fb28c53028c45b5578f2bfb105df92636d7d1c0d802ade",
    "docs/operations/GITHUB_CONTROLS.md": "149fb17b0e45ddf00c60d2777b5d97dbd01c032a4d8cb0db277b0aad8a8257a5",
    "docs/security/OSPS_BASELINE.md": "47a3ce8dbc7fe3e6d4451881179bb97f5eb5253c12b9f54c1e854a5b3cbfcf1f",
    "docs/security/SECRETS_AND_INCIDENTS.md": "dc595debb25ee71678338e699d6565c6cfdef28c1e516558c88cf41415c4a428",
    "docs/security/THREAT_MODEL.md": "417770f7fc2e1ddd4f291e93c83ddedf6f5a23e80f7c9368e53ee61cd960786b",
    ...
    "tools/tests/test_validate_foundation_hardening.py": "760845687e2c7881710910225f52a5c0479d5f1634de6b238fc09968bae40f76",
}
        ...
        if path.name == "ci.yml":
            ...
            require(
                ...
                (
                    ...
                    "INPUT_INTERNAL_PUBLISH_BASE_URL: https://api.scorecard.dev",
                    "INPUT_INTERNAL_DEFAULT_TOKEN: ${{ github.token }}",
                ),
            )
