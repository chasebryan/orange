...
and normative [`docs/SEMANTICS_2026.md`](../docs/SEMANTICS_2026.md). The
normative Orange 2026 syntax and semantic documents are digest protected. Adding
another compiler source or normative language file requires an intentional
policy and validator inventory update.
