...
mode, and bytes with the tested check root. Policy-valid source drift therefore
cannot produce a passing gate unless a trusted child restores the original
