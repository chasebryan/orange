...
- At exact `main` revision
  `9f458c04542c512a8c04b00cb7ce4ef6bacd1a79`, hosted runs completed green for
  Required CI `29171653266`, Workflow Online Audit `29171653264`, External
  Links `29171653282`, OpenSSF Scorecard `29171653261`, and CodeQL
  `29171652948`. Required CI exercised policy version `0.1.4` and all 65 tests.
- CodeQL run `29171652948` produced Python analysis `1467719573` with zero
  results across 50 configured rules and Actions analysis `1467719309` with
  zero results across 23 configured rules; neither analysis reported an error
  or warning. CodeQL alerts #1, #2, and #3 (`py/path-injection`) were fixed,
  not dismissed, at `2026-07-11T23:09:26Z`.

These observations are operating evidence only for the named revision,
configuration, event executions, and analysis rules. A green push-triggered run
...
| CTL-003 | GitHub secret scanning and push protection; credential exclusions in [`.gitignore`](../../.gitignore) | Current platform and repository controls at exact `main` revision `9f458c04542c512a8c04b00cb7ce4ef6bacd1a79` | Non-provider patterns and validity checks were disabled at the snapshot; scanners cannot guarantee absence and cannot undo exposure. |
