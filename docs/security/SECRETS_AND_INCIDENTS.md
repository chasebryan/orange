...
| Scorecard OIDC identity | Ephemeral on trusted `main` only | GitHub OIDC token issued to the write-scoped Scorecard job | Manual/non-main/fork event, static OIDC credential, unrelated job |
