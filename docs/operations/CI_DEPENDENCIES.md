...
40-character commit SHA. Scorecard instead runs as the separately admitted OCI
container recorded in section 4, selected directly by digest. Version comments
are review aids, not the enforced identities.
